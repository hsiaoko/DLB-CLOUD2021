...
public class TestCHBL {
	...
	//	ModelingVmList(vmList, brokerId, vmNum, (int)(1.4*(cloudletNum/vmNum)));
		ModelingVmList(vmList, brokerId, vmNum, 64*3);

		broker.submitVmList(vmList);
		cloudletList = new ArrayList<Cloudlet>();

		CloudletMap(cloudletNum, vmList, cloudletLength, cloudletFileSize, cloudletOutputSize, 1, brokerId);
	...
	private static void CloudletMap(int cloudletNum, List<Vm> vmList, int cloudletLength, int cloudletFileSize,
		...
		while(iterator.hasNext()) {
			...
			vmId = ConsistentHashingWithBoundedLoad.GetBin(consistentHashRouter, cloudletId + "");
